...
venue: "Newcastle University, Henry Daysh Building"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
startdate: XXXX      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: XXXX        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
